...
const Healthcare = () => {
  ...
  const solutions = [
    {
      title: "Shift Scheduling for Healthcare Staff",
      description:
        "Manage complex schedules and track attendance for medical and administrative teams.",
      icon: Calendar,
      features: [
    ...
    },
    {
      ...
      description:
        "Automate payroll processing, employee records, and compliance reporting.",
      icon: Wallet,
      features: [
    ...
    {
      title: "Staff Development & Performance Tracking",
      description:
        "Track employee performance, certifications, and training programs.",
      icon: Award,
      features: [
        "Performance reviews",
    ...
    },
    {
      ...
      description:
        "Allow staff to view schedules, submit leave requests, and access HR services via mobile app.",
      icon: Smartphone,
      features: [
  ...
  const benefits = [
    { text: "Simplify complex shift scheduling", icon: Calendar },
    { text: "Automated payroll processing", icon: Calculator },
    { text: "Track certifications & licenses", icon: Shield },
  ...
  const healthcareRoles = [
    { role: "Doctors", icon: Stethoscope },
    { role: "Nurses", icon: HeartPulse },
    { role: "Administrative Staff", icon: Users },
    { role: "Support Staff", icon: Syringe },
  ];
          ...
          <div className="flex flex-col lg:grid lg:grid-cols-2 gap-8 md:gap-12 lg:gap-16 items-center bg-gradient-to-br from-[#faf7f2] to-[#f5e6d3] rounded-xl sm:rounded-2xl p-6 sm:p-8 md:p-12 border-2 border-[#780000]">
            ...
            <div className="order-2 lg:order-1">
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-medium text-[#2b2d42] mb-3 md:mb-4 text-center lg:text-left px-4 sm:px-6 lg:px-0">
                Built for <span className="text-[#d62828]">Healthcare HR</span>
              </h2>
              <p className="text-sm sm:text-base md:text-lg text-[#4a4e69] mb-4 md:mb-6 leading-relaxed text-center lg:text-left px-4 sm:px-6 lg:px-0">
                HRPay Companion is designed specifically for healthcare HR
              ...
              <ul className="space-y-2 sm:space-y-3 px-4 sm:px-6 lg:px-0">
                {[
                  ...
                  "Manage complex shift schedules with ease",
        ...
        >
          <div className="text-center max-w-3xl mx-auto mb-8 md:mb-12 px-4 sm:px-6 lg:px-0">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-medium text-[#2b2d42] mb-3 md:mb-4">
              Designed for All{" "}
              <span className="text-[#d62828]">Healthcare Roles</span>
            </h2>
            <p className="text-sm sm:text-base md:text-lg text-[#4a4e69]">
              One HR system for your entire healthcare team.
            </p>
          </div>
        ...
        >
          <div className="text-center max-w-3xl mx-auto mb-8 md:mb-12 px-4 sm:px-6 lg:px-0">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-medium text-[#2b2d42] mb-3 md:mb-4">
              ...
              <span className="text-[#d62828]">Manage</span> Your Healthcare HR
            </h2>
            <p className="text-sm sm:text-base md:text-lg text-[#4a4e69]">
              From shift scheduling to compliance tracking.
            </p>
          </div>
          ...
          <div className="bg-gradient-to-br from-[#faf7f2] to-[#f5e6d3] rounded-xl sm:rounded-2xl p-6 sm:p-8 md:p-12 border-2 border-[#780000]">
            <div className="text-center max-w-3xl mx-auto">
              <h3 className="text-xl sm:text-2xl md:text-3xl font-medium text-[#2b2d42] mb-3 md:mb-4 px-4">
                Never Miss a{" "}
                <span className="text-[#d62828]">Certification or License</span>
              </h3>
              <p className="text-sm sm:text-base md:text-lg text-[#4a4e69] mb-5 md:mb-6 leading-relaxed px-4">
                Track licenses, certifications, and training requirements with
